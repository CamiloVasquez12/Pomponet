...
namespace PomponetWebsite.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public PeopleController(CropsDbContext context)
        {
            _context = context;
        }
		...
		public async Task<IActionResult> Details(int? id)
        {
            ...
            var people = await _context.People
                .FirstOrDefaultAsync(m => m.Id_Person == id);
            if (people == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("Id_Person,Names,Email,UserName,Password,Age,Deleted")] People people)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Person,Names,Email,UserName,Password,Age,Deleted")] People people)
        {
            if (id != people.Id_Person)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!PeopleExists(people.Id_Person))
                    {
                        return NotFound();
                    }
                    else
